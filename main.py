...
Label(sroot,text="Rishi Koushik Rajana",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="rishikoushikrajana15@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
#Label(sroot,text="9121998256",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=450)
#----------- main project------------------------------------------------------------------------------------------------------------------
def mainroot():
	#sroot.destroy()
	root = Tk()
	...
	root.title("Made with love by Rishi")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Rishi',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Rishi Koushik",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="Ms. Rashmika",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		...
		Label(emp1inf,text="Mr. Rishi kumar (Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
